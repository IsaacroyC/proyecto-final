<template>
  ...
  >
    ...
    >
      ...
      <v-toolbar-title>Ingresados</v-toolbar-title>
...
<script setup>
  const items = [
    ...
    { divider: true },
    {
      ...
      subtitle: '<span class="font-weight-bold">Gabriel</span> &mdash; Como estan?',
    },
    {
      avatar: 'https://picsum.photos/250/300?image=146',
      title: 'So long',
      subtitle: '<span class="font-weight-bold">Nancy</span> &mdash; Hola?',
    },
    {
      header: 'Last Week',
    },
    { divider: true },
    {
      ...
      title: 'Breakfast?',
      subtitle: '<span class="font-weight-bold">Patricia</span> &mdash; Estan bien?',
    },
    {
      avatar: 'https://picsum.photos/250/300?image=839',
      title: 'Winter Porridge <span class="text-grey-lighten-1"></span>',
      subtitle: '<span class="font-weight-bold">cc: Daniel</span> &mdash; Como estan?',
    },
    {
      avatar: 'https://picsum.photos/250/300?image=145',
      title: 'Oui oui',
      subtitle: '<span class="font-weight-bold">Nancy</span> &mdash; hola amigos',
    },
  ]
</script>